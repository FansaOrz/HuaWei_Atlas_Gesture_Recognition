...
//    std::cout << "callback function ININININIIN!!!!\n";
...
HIAI_StatusT HIAI_InitAndStartGraph() {
    ...
    target_port_config.engine_id = 368;
...
int main(int argc, char* argv[]) {
    ...
    engineId.engine_id = 611;    // 611 is input data engine
    engineId.port_id = 0;
...
//    std::cout << "sent data!!!!!!!!\n";
	...
	while(true){
        ...
        sleep(1000);
        end_time = (double)(clock()-start)/CLOCKS_PER_SEC;
